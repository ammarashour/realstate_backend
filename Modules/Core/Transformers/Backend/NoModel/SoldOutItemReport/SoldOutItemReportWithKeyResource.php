...
use Modules\Core\Transformers\Backend\Model\User\UserBoughtWithKeyResource;
...
class SoldOutItemReportWithKeyResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'authorizations' => app(PermissionServiceInterface::class)->authorizationWithoutModel(Constants::soldOutItemReportModule, Auth::id())
        ] + $changedCustomFieldFormat;
    }
}
